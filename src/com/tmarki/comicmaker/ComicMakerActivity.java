...
public class ComicMakerActivity extends Activity implements
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		/*
		 * for (CharSequence s : packImages.keySet()) { if (sm != null) {
		 * MenuItem mi = sm.add(getResources ().getString (R.string.pack) + " "
		 * + s); menuitems_Packs.put(mi, s); } }
		 */
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case (R.id.text_color):
			ColorPickerDialog cpd = new ColorPickerDialog(this, this, "key",
					mainView.getCurrentColor(), mainView.getCurrentColor());
			cpd.show();
			break;
		case (R.id.pen_width):
			WidthPicker np = new WidthPicker(this, this,
					mainView.getCurrentStrokeWidth());
			np.show();
			break;
		case (R.id.zoom):
			ZoomPicker zp = new ZoomPicker(this, this,
					mainView.getCanvasScale());
			zp.show();
			break;
		case (R.id.drafts):
			draftManager.show();
		...
		case (R.id.text_type):
			fontselect = new FontSelect(this, setFontTypeListener,
		...
		case (R.id.objmenu):
			if (mainView.getSelected() == null) {
				Toast.makeText(this, R.string.select_object_first,
						Toast.LENGTH_SHORT).show();
			} else {
			...
			break;
		case (R.id.settings):
			settings = new ComicSettings(this, mainView.getPanelCount(),
